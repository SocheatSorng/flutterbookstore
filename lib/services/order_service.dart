    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        if (data['success'] == true) {
          ...
          var orderId = data['data']['OrderID'] ?? data['data']['orderId'] ?? '';
          return {
            'success': true,
    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        if (data['success'] == true && data['data'] != null) {
          ...
          if (paginationData['data'] != null && paginationData['data'] is List) {
            ...
            final ordersList = List<Map<String, dynamic>>.from(paginationData['data'] as List);
            ...
            return ordersList.map((orderJson) {
              ...
              if (orderJson['order_details'] != null && orderJson['order_details'] is List) {
                final orderDetails = List<Map<String, dynamic>>.from(orderJson['order_details'] as List);
      ...
      return [
        Order(
          ...
          userId: userId.toString(),
          items: [
            OrderItem(bookId: '1', title: 'Flutter in Action', price: 99.99, quantity: 3)
          ],
          total: 299.97,
          status: 'Completed',
        ...
        Order(
          ...
          userId: userId.toString(),
          items: [
            OrderItem(bookId: '2', title: 'Dart Programming', price: 79.95, quantity: 2)
          ],
          total: 159.95,
          status: 'Shipping',
